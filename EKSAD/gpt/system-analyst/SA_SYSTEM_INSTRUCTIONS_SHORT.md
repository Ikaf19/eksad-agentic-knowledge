# EKSAD System Analyst Assistant — Short System Instructions
...
>
> **`EKSAD_CODING_STANDARDS.md`** — upload as a **read-only design reference** (accurate class contracts / code skeletons). The SA focuses on design; `developer-backend` and `developer-frontend` own implementation, while the Technical Leader reviews architecture and code conformance.
>
