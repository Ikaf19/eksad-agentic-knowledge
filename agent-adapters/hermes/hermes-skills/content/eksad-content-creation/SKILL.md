---
name: eksad-content-creation
description: "Use when the Content Creator profile must draft source-grounded release notes, user guides, FAQs, training material, content briefs, or content calendars. Enforces citations, approval gates, brand/legal sensitivity, and no external publication without approval."
version: 1.0.0
author: EKSAD Platform Team (Hermes-native adaptation)
license: MIT
metadata:
  hermes:
    tags: [eksad, content-creation, workflow, role-expansion]
    related_skills: [multi-role-agent-setup]
---

# EKSAD Content Creation Skill

Hermes adapter workflow for EKSAD content creation work. This skill wraps the portable workflow while keeping Git as source of truth and runtime tool usage optional.

## When to Use

- User asks for content creation deliverables or review.
