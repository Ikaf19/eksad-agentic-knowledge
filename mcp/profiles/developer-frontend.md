...
Frontend Developer may use code intelligence, Git read-only, OpenAPI, Playwright, and optional Figma read-only.

## Source of truth

- `portable/roles/developer-frontend.md` when present.
