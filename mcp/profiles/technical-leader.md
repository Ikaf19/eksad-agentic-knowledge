...
Technical Leader may inspect code, CI, quality, security, architecture, and optional design/data evidence for review gates.

## Source of truth

- `portable/roles/technical-leader.md`.
...
`content-draft`, `notebook-sandbox`
