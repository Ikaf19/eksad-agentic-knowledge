...
Project Manager consumes Git/CI/quality/security/observability status evidence only; no specialist tool ownership.

## Source of truth

- `portable/roles/project-manager.md` when present.
