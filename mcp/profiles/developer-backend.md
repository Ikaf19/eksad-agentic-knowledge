...
Backend Developer may use code intelligence, Git read-only, schema read-only, OpenAPI, and selected event topology evidence for implementation context.

## Source of truth

- `portable/roles/developer-backend.md` when present.
