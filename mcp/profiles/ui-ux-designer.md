...
UI/UX Designer may inspect RAG, scoped browser/UI behavior, Figma/design assets, and visual evidence for UX/design handoff.
...
`codebase-memory`, `data-bi-readonly`, `notebook-sandbox`, `observability-readonly`, `postgres-schema-readonly`
